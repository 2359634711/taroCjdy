...
var Index = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Index() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Index.__proto__ || Object.getPrototypeOf(Index)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["loopArray67", "$compid__206", "$compid__207", "$compid__208", "goodTitle"], _this.config = {
  ...
  _createClass(Index, [{
    ...
    value: function _createData() {
      ...
      var loopArray67 = goodTitle.map(function (val, _anonIdx) {
        val = {
          $original: (0, _index.internal_get_original)(val)
        };
        var $compid__205 = (0, _index.genCompid)(__prefix + "HkeSnssSdu" + _anonIdx);
