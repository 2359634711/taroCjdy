...
var CardItem = (_temp2 = _class = function (_BaseComponent) {
  ...
  function CardItem() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = CardItem.__proto__ || Object.getPrototypeOf(CardItem)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["cardInfo", "loopArray9", "onAction"], _this.anonymousFunc0Map = {}, _this.customComponents = ["InfoItem"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(CardItem, [{
    ...
    value: function _createData() {
      ...
      var loopArray9 = cardInfo.list.map(function (val, __index0) {
        val = {
